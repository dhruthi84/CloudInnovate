...
const fileNames = properties.get('release_notes.seq.fileNames');
const arr = properties.get('release_notes.seq.arr');
/* GET api listing. */
router.get('/', (req, resp) => {
   ...
   // var await = sync.await;
    ...
    converter = new showdown.Converter();
		...
		//	console.log("==============data================="+data);
			...
			var dn1='<a href="https://gbsartifactory.in.edst.ibm.com/artifactory/NextGenTooling/185/Nextgen_Ingestion_dev.zip">download direct</a>';
              resp.json(html);
